...
class Model(object):
    ...
    def __init__(self, policy, env, nsteps, ent_coef=0.01, vf_coef=0.5, max_grad_norm=0.5, lr=7e-4,
        ...
        def train(obs, states, sum_rewards, masks, actions, values, dones, onestep_rewards):
            ...
            td_map = {train_model.X: obs, A: actions, ADV: advs, R_sum: sum_rewards, DONE: dones,
                      R_onestep: onestep_rewards, LR: cur_lr}
    ...
    **network_kwargs:   keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    for update in range(1, total_timesteps // nbatch + 1):
        ...
        if update % log_interval == 0 or update == 1:
            ...
            ev = explained_variance(values, sum_rewards)
